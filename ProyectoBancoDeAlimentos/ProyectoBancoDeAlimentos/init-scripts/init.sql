...
INSERT INTO producto (id_producto, nombre, descripcion, precio_base, id_subcategoria, activo, unidad_medida, id_marca) VALUES
  ...
  (6,'Leche Deslactosada 1L','UHT',            34.00, 2, TRUE, 'litro',  3)
ON CONFLICT DO NOTHING;

INSERT INTO imagen_producto (id_imagen, id_producto, url_imagen, orden_imagen) VALUES
  (1,1,'https://ejemplo/img/arroz1.png',0),
  (2,2,'https://ejemplo/img/leche1.png',0),
  (3,3,'https://ejemplo/img/atun1.png',0),
  (4,4,'https://ejemplo/img/frijol1.png',0),
  (5,5,'https://ejemplo/img/yogurt1.png',0),
  (6,6,'https://ejemplo/img/leche2.png',0)
ON CONFLICT DO NOTHING;
